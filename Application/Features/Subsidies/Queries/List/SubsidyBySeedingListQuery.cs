...
{
    public class SubsidyBySeedingListQuery : IRequest<Result<List<CommonSubsidyOutputQueryModel>>>
    {
        public int SeedingId { get; set; }

        public class SubsidyBySeedingListQueryHandler : IRequestHandler<SubsidyBySeedingListQuery, Result<List<CommonSubsidyOutputQueryModel>>>
        {
            private readonly IFarmerDbContext farmerDbContext;
            private readonly IMapper mapper;

            public SubsidyBySeedingListQueryHandler(IFarmerDbContext farmerDbContext, IMapper mapper)
            {
            ...
            public async Task<Result<List<CommonSubsidyOutputQueryModel>>> Handle(
                SubsidyBySeedingListQuery request,
